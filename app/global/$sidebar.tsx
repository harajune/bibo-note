...
function NarrowSidebar({ isOpen, setOpen }: NarrowSidebarProps) {
  return (
    ...
    <div class="fixed inset-0 flex">
      <div class={"relative mr-16 flex w-full max-w-xs flex-1 transition ease-in-out duration-300 transform " + (isOpen ? "translate-x-0" : "-translate-x-full")}>
        <div class={"absolute left-full top-0 flex w-16 justify-center pt-5 ease-in-out duration-300 " + (isOpen ? "opacity-100" : "opacity-0")}>
